...
public class MoveNextTest extends AbstractTest {
    ...
    @Test
    public void moveNextDependencyManagementDirect() throws Exception {
        File rootDirectory = createCopy("scenarios/basic/move.next.dependency.management.direct/before/");
        File rootPom = new File(rootDirectory.getAbsolutePath() + File.separator + MavenModel.FILENAME_POM_XML);
        ...
        assertPathEqualsRecursively("scenarios/basic/move.next.dependency.management.direct/expected", rootDirectory);
    }
